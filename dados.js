...
/* O conteúdo fica sempre acima das nuvens. */
.cabecalho,
.area-menu,
.destaques,
.rodape {
...
.camada-nuvem-pequena {
  position: absolute;
  pointer-events: none;
  z-index: 0;
  opacity: .88;
}
.camada-nuvem-pequena img {
  display: block;
  width: 100%;
  height: 100%;
  object-fit: contain;
}
.nuvem-p1 { width: 95px; height: 48px; top: 55px; left: 8%; }
.nuvem-p2 { width: 125px; height: 62px; top: 92px; right: 11%; }
.nuvem-p3 { width: 75px; height: 38px; top: 150px; right: 31%; }

.camada-nuvem-pequena { z-index: 0; }
