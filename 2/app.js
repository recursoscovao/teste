...
.botao-menu:hover, .botao-seta:hover {
...
.menu-ano:active { transform: scale(.98); }
...
.titulo-menu {
  ...
  box-shadow: 0 3px 7px rgba(118,88,17,.12), inset 0 1px 0 rgba(255,255,255,.95);
}
...
.botao-ano {
  ...
  cursor: pointer;
  overflow: hidden;
  box-shadow: 0 9px 15px ${DADOS.cores.sombra}, inset 0 1px 1px rgba(255,255,255,.7);
...
.botao-ano:hover {
  ...
  box-shadow: 0 13px 20px ${DADOS.cores.sombraForte}, inset 0 1px 1px rgba(255,255,255,.75);
}

.botao-ano:active { transform: translateY(-1px); }
...
.destaques {
  ...
  box-shadow: 0 7px 18px rgba(25,100,150,.10), inset 0 1px 0 rgba(255,255,255,1);
}
...
.estrela { color: #FFB400; font-size: 25px; line-height: 1; }
.info {
  width: 25px;
  height: 25px;
  display: grid;
...
@media (max-width: 1100px) {
  .jogos { grid-template-columns: repeat(3, 1fr); }
}

@media (max-width: 900px) and (orientation: portrait) {
  .cabecalho { height: 70px; }
  .botao-menu, .botao-seta { width: 50px; height: 50px; }
  .botao-menu { left: 14px; }
  .botao-seta { right: 14px; }
  .marca-sol { width: 43px; height: 43px; }
  .marca-texto h1 { font-size: 22px; }
  .marca-texto p { font-size: 11px; }
  .menu-acordeao { top: 62px; left: 14px; }
  .anos { grid-template-columns: 1fr; gap: 9px; }
  .botao-ano { height: 126px; flex-direction: row; justify-content: flex-start; padding: 10px 18px; gap: 15px; }
  .icone-ano { width: 76px; height: 76px; }
  .texto-ano { text-align: left; }
  .nome-ano { font-size: 22px; }
  .idade-ano { font-size: 13px; margin-top: 6px; }
  .jogos { grid-template-columns: repeat(3, 1fr); }
}
...
@media (max-width: 600px) and (orientation: portrait) {
  ...
  .marca-texto p { margin-top: 3px; font-size: 9px; }
  .menu-acordeao { top: 54px; left: 10px; width: calc(100vw - 20px); max-width: 300px; }
  .titulo-menu { margin-top: 20px; margin-bottom: 14px; padding: 7px 19px; }
  .titulo-menu h2 { font-size: 18px; }
  .anos { grid-template-columns: 1fr; gap: 8px; }
  .botao-ano { height: 100px; padding: 8px 12px; gap: 10px; flex-direction: row; justify-content: flex-start; }
  .icone-ano { width: 58px; height: 58px; }
  .nome-ano { font-size: 18px; }
  .idade-ano { font-size: 11px; margin-top: 4px; }
  .destaques { padding: 10px 8px 12px; border-radius: 17px; }
...
function preencherTextos() {
  ...
  if (informacao) informacao.textContent = DADOS.pagina.informacao;
}
  ...
  DADOS.destaques.forEach(jogo => {
    ...
    if (jogo.pagina) {
      ...
      if (cartao) {
        ...
        const abrirJogo = () => { window.location.href = jogo.pagina; };
