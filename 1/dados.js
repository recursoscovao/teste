/*
================================================================
 RECURSOS COVÃO — DADOS DO 1.º ANO
================================================================
...
.nuvem-pequena{
  ...
  z-index:0;
  transform:translate(-50%,-50%) rotate(var(--rotacao-nuvem));
}
...
function criarCartoesAno(){
  ...
  DADOS.anos.forEach((ano)=>{
    ...
    /*
      Os icons das áreas ficam na raiz,
      enquanto o index está dentro de /1/.
    */

    img.src =
      DADOS.icons.areas[ano.icon];
